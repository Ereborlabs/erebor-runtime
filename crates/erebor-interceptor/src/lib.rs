...
pub use host::{
    ...
    RecoveredContainerActivationCommandResultV1, EXCEPTION_USE_RECEIPT_CAPACITY,
    REQUIRED_IDENTITY_PROGRAMS, REQUIRED_QUALIFICATION_LSM_PROGRAMS,
    REQUIRED_QUALIFICATION_PROGRAMS,
};
pub use manifest::{
