...
pub use config::{
    ...
    DesktopAuditSurfaceLoggingConfig, DockerSessionCommandOptions, DockerSessionCommandPlan,
    DockerSessionMount, DockerSessionRunnerConfig, DockerSessionRunnerLayerConfig,
    FilesystemAuditSurfaceLoggingConfig, FilesystemBackendConfig, FilesystemBackendKind,
    ...
    SessionRunPlan, SessionRunnerConfig, SessionRunnerKind, SessionRunnerLayerConfig,
    SessionSurfaceKind, SessionSurfaceLayers, SessionSurfaceStartPlan, SessionSurfaceToggleConfig,
...
pub use session::{
    ...
    CallerHomeFilesystemSource, CallerHomeFilesystemSourceAccess, CallerHomeFilesystemSourceKind,
    CallerHomeFilesystemSourceView, DaemonFailureMode, DockerSessionRunner, EndpointProjection,
    EvidenceRequirement, FilesystemProjection, FilesystemProjectionTarget, ImmutableIdentity,
    LinuxHostSessionRunner, OutputEndpoints, OutputPlan, OutputStreamRequirements,
    PreparedFilesystemProjection, PreparedPrivateStateProjection, PreparedWritableFilesystemView,
    ...
    SessionCapturedRunOutcome, SessionLifecycleState, SessionOwner, SessionResourceAssociation,
    SessionRunOutcome, SessionRunnerLauncher, SessionSpec, TerminalSize, WorkloadPrivilegePlan,
