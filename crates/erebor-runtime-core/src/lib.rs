...
pub use config::{
    ...
    CodexHookEventSchemaLayerConfig, CodexProfileLayerConfig, DesktopAuditSurfaceLoggingConfig,
    DockerSessionCommandOptions, DockerSessionCommandPlan, DockerSessionMount,
    DockerSessionRunnerConfig, DockerSessionRunnerLayerConfig, FilesystemAuditSurfaceLoggingConfig,
