...
pub(super) struct InterceptionDecisionReply {
    request_id: u64,
}

impl InterceptionDecisionReply {
    pub(super) const fn new(request_id: u64) -> Self {
        Self { request_id }
    }
    ...
    pub(super) fn surface(&self, decision: SurfaceInterceptionDecision) -> InterceptionDecision {
        ...
        match decision {
            ...
            SessionInterceptionDecision::Deny => self.deny(rule_id, reason),
