...
const MATRIX: &str = include_str!("fixtures/phase3-simulation.json");
const FIXTURE_REGISTRY: &str = include_str!("../../../spec/qualification/v1/fixtures.yaml");

const REQUIRED_PHASE45_FIXTURES: [&str; 38] = [
...
#[test]
fn phase3_simulates_every_required_future_fixture_and_incident_branch(
    ...
    assert_eq!(
        matrix_registered,
        REQUIRED_PHASE45_FIXTURES.into_iter().collect(),
        "matrix must cover exactly the Phase 4/5 fixtures owned first by Phase 3 simulation"
    );
