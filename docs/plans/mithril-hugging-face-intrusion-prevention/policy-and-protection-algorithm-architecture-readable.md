...
| 3 | `ALWAYS` | `EXEC-COMMIT-STATE-001`, `EXEC-CONCURRENT-002`, `ID-CGROUP-ESCAPE-001`, `ID-CLONE-CGROUP-002`, `ID-CREATOR-PARENT-007`, `ID-MOVED-PARENT-FORK-004`, `ID-MOVED-TASK-EXEC-005`, `ID-TASK-COORD-FINALIZE-006`, `IPC-ENDPOINT-RESTART-006`, `IPC-PEER-RACE-004`, `IPC-RELATIONSHIP-ALLOW-003`, `IPC-RELATIONSHIP-LOSS-002`, `IPC-RELATIONSHIP-UNMATCHED-005`, `NATIVE-STATE-REF-LIFETIME-001`, `STATE-FORK-IPC-002`, `STATE-THREAD-RACE-001` |
