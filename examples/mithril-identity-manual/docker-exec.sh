...
identity_read_host_pid "docker exec sleep host PID: "
identity_inspect_task docker-exec "$identity_read_pid"
identity_assert_external "$identity_work/docker-exec.json"
identity_pass "PASS: docker exec is a restricted external root"
