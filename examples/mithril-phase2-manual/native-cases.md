# Phase 2 Native Identity And Authorization Cases
...
| `ID-CREATOR-PARENT-007` | Reparent or orphan a child after native creation. | The immutable creator edge stays exact while the real-parent interval changes. |
...
entry class, optional slot identity, expiry, and replay state. Phase 4 must
